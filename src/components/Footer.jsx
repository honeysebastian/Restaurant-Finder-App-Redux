...
function Footer() {
    return (
       <>
       <div style={{ height: '300px' }} className='mt-5 w-100 bg-dark p-5 text-white'>
            <div className="d-flex justify-content-between">
                <div style={{ width: '400px' }} className="intro">
                    <h5 style={{fontSize:'1.5rem',color:'red'}}><i className="fa-solid fa-bell-concierge me-2"></i><span className='text-light'>QUICK</span> MUNCH</h5>
                ...
                <div className="links d-flex flex-column">
                    ...
                    <Link to={'/cart'} style={{ textDecoration: 'none', color: 'white' }}>List</Link>
                ...
                <div className="contact  d-flex flex-column">
                    ...
                    <div className="d-flex">
                        ...
                        <button style={{ color: 'white', width: '60px', height: '60px' }} className='bg-danger  border-0 rounded fw-bolder fs-5 '><i className="fa-solid fa-arrow-right"></i></button>
                    </div>
            ...
            <p className='text-center'>Copyright &copy; Restaurant App 2024. Built with React</p>
        </div>
       </>
    )
}
